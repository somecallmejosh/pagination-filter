(function () {
  ...
  function StudentObject(avatar, name, email, dateJoined) {
    ...
    // StudentObject is immediately to the left of the dot,
    // and therefore, 'this' references StudentObject.
    this.avatar = avatar;
    this.name = name;
    this.email = email;
  ...
  function pagination(e) {
    ...
    // toggle active class on pagination links
      ...
      // 'this' references the target in this case.
      // It refers to the actual link referenced in the event handler.
      // Very much like $(this) in jQuery, in this instance.
